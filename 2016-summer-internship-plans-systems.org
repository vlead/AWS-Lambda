...
| 2.   | Docker operations -                                              |               |
|------+------------------------------------------------------------------+---------------|
| a).  | Create/Delete Containers                                         | YES           |
|------+------------------------------------------------------------------+---------------|
| b).  | Install applications inside containers                           | YES           |
|------+------------------------------------------------------------------+---------------|
| c).  | List images, containers, and running processes                   | YES           |
|------+------------------------------------------------------------------+---------------|
| d).  | Other Docker operation commands                                  | YES           |
|------+------------------------------------------------------------------+---------------|
| e).  | DockerFile                                                       | YES           |
|------+------------------------------------------------------------------+---------------|
| f).  | Start/Stop containers                                            | YES           |
|------+------------------------------------------------------------------+---------------|
| g).  | Demonize a container                                             | YES           |
|------+------------------------------------------------------------------+---------------|
